...
public class GameDataManager : AutoSingleton<GameDataManager>
{
    ...
    public static void LocalAllLoad(Action complete)
    {
        ...
        string MobTabledata = Gzip.DeCompression( Resources.Load<TextAsset>("Json/MobTable").text);
...
case TABLE.MobTable:
        MobTable d_MobTable = new MobTable();
        d_MobTable.SetJson(data);
        obj  = d_MobTable;
        break;
case TABLE.NomalWaveTable:
